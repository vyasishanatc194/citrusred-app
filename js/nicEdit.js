...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','insertHTML','indent','outdent','image','upload','link','unlink','forecolor','bgcolor'],
	...
	mouseClick : function() {
		if(!this.isDisabled) {
			if(this.pane && this.pane.pane) {
				...
				this.pane = new nicEditorPane(this.contain,this.ne,{width : (this.width || '270px'), backgroundColor : '#fff',position:'fixed',left:(this.left || '700px')},this);
				this.addPane();
...
var nicEditorSelect = bkClass.extend({
	...
	construct : function(e,buttonName,options,nicEditor) {
		...
		// Push personalization to the right
		...
		this.txt = new bkElement('div').setStyle({overflow : 'hidden', 'float' : 'left', width : '78px', height : '14px', marginTop : '10px', fontFamily : 'sans-serif', textAlign : 'center', fontSize : '12px', fontWeight: '700'}).addClass('selectTxt').appendTo(this.items);
