<?php
	...
	if(CONFIG_SYS_VIEW_ONLY || !CONFIG_OPTIONS_EDITABLE)
	{
		...
		$session->gc();
		$_GET['path'] = empty($_GET['path'])?CONFIG_SYS_ROOT_PATH . "ajax_image_editor_demo.jpg?v=6-20-13":$_GET['path'];
...
<script type="text/javascript" src="jscripts/ajaximageeditor_c.js?v=6-20-13"></script>

<!--<script type="text/javascript" src="jscripts/jquery.js?v=6-20-13"></script>
<script type="text/javascript" src="jscripts/form.js?v=6-20-13"></script>
<script type="text/javascript" src="jscripts/select.js?v=6-20-13"></script>
<script type="text/javascript" src="jscripts/jqModal.js?v=6-20-13"></script>
<script type="text/javascript" src="jscripts/rotate.js?v=6-20-13"></script>
<script type="text/javascript" src="jscripts/interface.js?v=6-20-13"></script>-->


<script type="text/javascript" src="jscripts/ajaximageeditor.js?v=6-20-13"></script>
...
<link href="theme/<?php echo CONFIG_THEME_NAME; ?>/css/ajaximageeditor.css?v=6-20-13" type="text/css" rel="stylesheet" />
<link href="theme/<?php echo CONFIG_THEME_NAME; ?>/css/jqModal.css?v=6-20-13" type="text/css" rel="stylesheet" />
...
<div id="imageArea">
    ...
    <div id="resizeMe">
    	...
    	<div id="resizeSW"></div>
    	<div id="resizeS"></div>
		<img id="loading" style="display:none;" src="theme/<?php echo CONFIG_THEME_NAME; ?>/images/ajaxLoading.gif?v=6-20-13" />
    </div>
</div>
    <div id="hiddenImage">
    </div>
