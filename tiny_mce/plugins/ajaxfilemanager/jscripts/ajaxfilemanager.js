	      ...
	      if(typeof(selectFile) != 'undefined' && (count == 1))
		   {
		   	$('#selectCurrentUrl').unbind('click').click( 
		   		function()
		   		{
		   			...
		   			var newurl = info.url;	
					//alert(newurl);
					newurl = newurl.replace("data/www/redcappi/rcdata/blog/","asset/uploaded/");					
					newurl = newurl.replace("var/www/redcappi/rcdata/blog/","asset/uploaded/");					
					newurl = newurl.replace("C:/xampp/htdocs/rcdata/blog/","asset/uploaded/");					
					//alert(newurl);
					selectFile(newurl);
		   		}
		   	);
