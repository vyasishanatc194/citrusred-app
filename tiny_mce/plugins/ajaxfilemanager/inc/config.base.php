...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//FILESYSTEM CONFIG
		...
		*/
	if('www.redcappi.dev' == $_SERVER['SERVER_NAME']){
		define('CONFIG_SYS_DEFAULT_PATH', 'c:/xampp/htdocs/rcdata/blog/'); //accept relative path only
		define('CONFIG_SYS_ROOT_PATH', 'c:/xampp/htdocs/rcdata/blog/');	//accept relative path only
	}else{
		define('CONFIG_SYS_DEFAULT_PATH', '/var/www/redcappi/rcdata/blog/'); //accept relative path only
		define('CONFIG_SYS_ROOT_PATH', '/var/www/redcappi/rcdata/blog/');	//accept relative path only
	}
